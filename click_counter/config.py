...
class EnvVars(Enum):
    ...
    CLICK_USERS_TABLE_NAME = "CLICK_USERS_TABLE_NAME"
...
class ConfigDefaults:
    ...
    CLICK_USERS_TABLE = "click_users_dev"
...
class Configuration(ConfigDefaults):
    ...
    @property
    def click_users_table(self):
        env_var = os.getenv(EnvVars.CLICK_USERS_TABLE_NAME.value)
        if env_var:
            return env_var
        else:
            return self._click_users_table
