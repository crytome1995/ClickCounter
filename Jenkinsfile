...
podTemplate(label: label, 
    containers: [
        containerTemplate(name: 'python', image: 'python:3.9.6-slim',ttyEnabled: true, privileged: true, command: 'cat', envVars: [envVar(key: 'E2E_HOST', value: 'http://clickcounter.control.clickthebutton.click')]),
